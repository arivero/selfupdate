...
# The supported trainer's eval path is where a half-installed venv actually
# bites, and it bites
...
if os.environ.get("SELFUPDATE_VENV_CORE_ONLY") == "1":
    print("eval.standard skipped (explicit core-only runtime)")
else:
    try:
