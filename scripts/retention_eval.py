...
Usage:
  ...
  python scripts/retention_eval.py --build-cache

  # evaluate one or more checkpoints (paths may live in sibling checkouts)
  python scripts/retention_eval.py --checkpoints runs/<run>/checkpoint ...
  python scripts/retention_eval.py --glob 'runs/*/checkpoint'
  python scripts/retention_eval.py --manifest runs/retention_manifest.tsv
"""
