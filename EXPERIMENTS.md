...
is an allowance regression: the preserved fixed-4096 run measured only 6.81%
hard cuts, but lacks exact token IDs and must be regenerated by the current
writer before cache construction.
