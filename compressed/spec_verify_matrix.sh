...
#
#   compressed/spec_verify_matrix.sh 27b|35b|26b|31b|122b [gpu]
#
...
$PY compressed/build_teacher_cache.py --config "$BASE" --experiment "$EXP" \
...
$PY compressed/train.py --config "$BASE" --experiment "$EXP"
