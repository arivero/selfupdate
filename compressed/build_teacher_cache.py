...
``compressed/rag_generation_gate.py``; cache construction never runs the teacher
...
Usage:
    python compressed/build_teacher_cache.py [--config configs/base.yaml] [--experiment ...]
"""
